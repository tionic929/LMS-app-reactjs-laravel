    ...
    return (
        <main className="flex-1 overflow-auto p-6 bg-gray-50">
            <div className="mx-auto">
                <h1 className="text-3xl font-extrabold text-gray-900 mb-6">{user?.role === 'admin' ? 'Admin Dashboard' : 'Dashboard'}</h1>

                {user?.role === 'learner' && (
                    <div className="mb-6 p-4 bg-white rounded-xl shadow-sm border border-gray-100 text-gray-700">
                        Your main activity is in <span className="font-semibold">Courses</span>.
                    </div>
                )}
