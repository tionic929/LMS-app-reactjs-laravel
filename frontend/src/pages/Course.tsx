    ...
    <main className="max-w-7xl mx-auto p-6">
      ...
      {loading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[...Array(6)].map((_, index) => (
            <div key={index} className="rounded-xl bg-white border border-gray-200 shadow-sm animate-pulse">
              ...
              <div className="p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {/* Icon skeleton */}
                  <div className="shrink-0 h-8 w-8 bg-gray-200 rounded"></div>
                </div>
                {/* Badge skeleton */}
                <div className="mt-3">
              ...
              {/* Footer skeleton */}
              <div className="px-5 py-3 border-t bg-gray-50/60 flex items-center justify-between gap-2">
